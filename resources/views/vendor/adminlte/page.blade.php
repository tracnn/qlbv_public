...
@section('body')
    <div class="wrapper">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{route('user.changepass')}}" style="color:grey;">
                                            <i class="fa fa-fw fa-lock"></i> {{ trans('adminlte::adminlte.change_password') }}
                                        </a>
                                    </li>                                    
                                    <li>
                                        <a href="#" style="color:grey;" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            <i class="fa fa-fw fa-power-off"></i> {{ trans('adminlte::adminlte.log_out') }}
                                        </a>
                                    </li>
                                </ul>
        ...
        <footer class="main-footer">
            ...
            {!! config('adminlte.footer', 'Copyright &#9400; by <b> <a href="http://facebook.com/trac.nguyenngoc" target="_blank">NNT</a></b>') !!}
        </footer>
