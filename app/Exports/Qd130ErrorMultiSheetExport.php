...
class Qd130ErrorMultiSheetExport implements WithMultipleSheets
{
    ...
    public function __construct($fromDate, $toDate, $xml_filter_status, $date_type, $qd130_xml_error_catalog_id, $payment_date_filter)
    {
    ...
    {
        return [
            new Qd130ErrorExport($this->fromDate, $this->toDate, $this->xml_filter_status, $this->date_type, $this->qd130_xml_error_catalog_id, $this->payment_date_filter),
