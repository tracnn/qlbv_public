...
class WordOfTheDay extends Command
{
     ...
     * @var string
     */
    protected $signature = 'word:day {--yesterday}';
    ...
    {
        return XmlErrorCheck::whereBetween('updated_at', [$fromDateTime, $toDateTime])
        ->with('xmlErrorCatalog')
        ->get();
    }
    ...
    )
    {
        ...
        foreach ($emails as $key => $value) { 
            ...
            do {
                try {
                    Mail::send('templates.mail-import', array(
                        'name' => $value->name,
                        'from_date' => $fromDate,
                        'to_date' => $toDate,
                        'email' => $value->email,
