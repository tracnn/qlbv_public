...
class sendXml3176XmlErrors extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sendxml3176errors:day {--yesterday}';
    ...
    {
        return Xml3176ErrorResult::whereBetween('updated_at', [$fromDateTime, $toDateTime])
        ->get();
    }
    ...
    )
    {
        ...
        foreach ($emails as $key => $value) { 
            ...
            do {
                try {
                    Mail::send('templates.mail-xml3176-errors', array(
                        'name' => $value->name,
                        'from_date' => $fromDate,
                        'to_date' => $toDate,
                        'email' => $value->email,
