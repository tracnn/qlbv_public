...
class Xml3176Service
{
    ...
    public function deleteXml3176XmlAndError($ma_lk)
    {
        try {
            ...
            Xml3176Xml1::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml2::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml3::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml4::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml5::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml6::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml7::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml8::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml9::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml10::where('ma_lk', $ma_lk)->delete();
            Xml3176Xml11::where('ma_lk', $ma_lk)->delete();
    ...
    public function storeXml3176Xml1($data, $xmlType)
    {
        ...
        try {
            ...
            $xml1 = Xml3176Xml1::updateOrCreate($attributes, $values);
        ...
        if (isset($data->DSACH_HO_SO_BENH_AN_CHAM_SOC_VA_DIEU_TRI_HIV_AIDS->HO_SO_BENH_AN_CHAM_SOC_VA_DIEU_TRI_HIV_AIDS) && 
            ...
            foreach ($data->DSACH_HO_SO_BENH_AN_CHAM_SOC_VA_DIEU_TRI_HIV_AIDS->HO_SO_BENH_AN_CHAM_SOC_VA_DIEU_TRI_HIV_AIDS as $record) {
                ...
                try {
                    ...
                    // Assuming there is a model Xml3176Xml6 for XML6 data
                    $xml6 = Xml3176Xml6::updateOrCreate($attributes, $values);
        ...
        if (isset($data->DSACH_CHITIET_DIEUTRI_BENHLAO->CHITIET_DIEUTRI_BENHLAO) &&
            ...
            foreach ($data->DSACH_CHITIET_DIEUTRI_BENHLAO->CHITIET_DIEUTRI_BENHLAO as $record) {
                ...
                try {
                    ...
                    $xml15 = Xml3176Xml15::updateOrCreate($attributes, $values);
    ...
    {
        $types = [
            'XML1' => Xml3176Xml1::class,
            'XML2' => Xml3176Xml2::class,
            'XML3' => Xml3176Xml3::class,
            'XML4' => Xml3176Xml4::class,
            'XML5' => Xml3176Xml5::class,
            'XML6' => Xml3176Xml6::class,
            'XML7' => Xml3176Xml7::class,
            'XML8' => Xml3176Xml8::class,
            'XML9' => Xml3176Xml9::class,
            'XML10' => Xml3176Xml10::class,
            'XML11' => Xml3176Xml11::class,
            'XML13' => Xml3176Xml13::class,
            'XML14' => Xml3176Xml14::class,
            'XML15' => Xml3176Xml15::class,
        ];
