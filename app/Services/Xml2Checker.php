...
class Xml2Checker
{
     ...
     * @return void
     */
    public function checkErrors(XML2 $data): void
    {
        ...
        // Kiểm tra thông tin thuốc nếu ma_nhom thuộc drugGroups và ma_khoa không thuộc excludedDepartments
     ...
     * @return Collection
     */
    private function checkOrderTime(XML2 $data): Collection
    {
        $errors = collect();
     ...
     * @return Collection
     */
    private function checkMedicalStaff(XML2 $data): Collection
    {
        $errors = collect();
     ...
     * @return Collection
     */
    private function checkDrugCatalog(XML2 $data): Collection
    {
        $errors = collect();
