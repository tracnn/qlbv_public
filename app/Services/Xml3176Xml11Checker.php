...
class Xml3176Xml11Checker
{
    ...
    protected function setConditions()
    {
        ...
        $this->docXml11Type = config('xml3176.type_xml11_doc');
    ...
    /**
     * Check Xml3176Xml11 Errors
     *
     * @param Xml3176Xml11 $data
     * @return void
     */
    public function checkErrors(Xml3176Xml11 $data): void
    {
     ...
     * @return Collection
     */
    private function infoChecker(Xml3176Xml11 $data): Collection
    {
        $errors = collect();
        ...
        if (empty($data->tu_ngay)) {
            ...
            try {
                ...
                $ngayRaDate = Carbon::createFromFormat('YmdHi', $data->Xml3176Xml1->ngay_ra)->startOfDay();
        ...
        if (empty($data->den_ngay)) {
            ...
            try {
                ...
                $ngayVaoDate = Carbon::createFromFormat('YmdHi', $data->Xml3176Xml1->ngay_vao)->startOfDay();
