...
class Xml3176Xml13Checker
{
    ...
    /**
     * Check Xml3176Xml13 Errors
     *
     * @param Xml3176Xml13 $data
     * @return void
     */
    public function checkErrors(Xml3176Xml13 $data): void
    {
     ...
     * @return Collection
     */
    private function infoChecker(Xml3176Xml13 $data): Collection
    {
        $errors = collect();
