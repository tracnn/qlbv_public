...
class Xml3176Xml14Checker
{
    ...
    /**
     * Check Xml3176Xml14 Errors
     *
     * @param Xml3176Xml14 $data
     * @return void
     */
    public function checkErrors(Xml3176Xml14 $data): void
    {
     ...
     * @return Collection
     */
    private function infoChecker(Xml3176Xml14 $data): Collection
    {
        $errors = collect();
