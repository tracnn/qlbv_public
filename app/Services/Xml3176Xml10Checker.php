...
class Xml3176Xml10Checker
{
    ...
    /**
     * Check Xml3176Xml10 Errors
     *
     * @param Xml3176Xml10 $data
     * @return void
     */
    public function checkErrors(Xml3176Xml10 $data): void
    {
     ...
     * @return Collection
     */
    private function infoChecker(Xml3176Xml10 $data): Collection
    {
        $errors = collect();
