...
class MedicalSupplyUpdateConstraint extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('medical_supply_catalogs', function (Blueprint $table) {
            ...
            $table->dropUnique('unique_medical_supply'); // Thay 'ma_vat_tu' bằng tên của unique constraint cũ nếu khác

            // Thêm unique constraint mới
            $table->unique(['ma_vat_tu', 'ten_vat_tu', 'tt_thau', 'don_gia_bh', 'tu_ngay'], 'unique_medical_supply');
        });
    }
