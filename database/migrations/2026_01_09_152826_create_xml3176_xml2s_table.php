...
class CreateXml3176Xml2sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('xml3176_xml2s', function (Blueprint $table) {
            $table->increments('id');
            $table->string('ma_lk');
            $table->integer('stt');
            ...
            // Adding index
            $table->unique(['ma_lk', 'stt'], 'xml3176_xml2s_ma_lk_stt_unique');
            $table->index('ma_lk');
    ...
    {
        Schema::dropIfExists('xml3176_xml2s');
    }
}
