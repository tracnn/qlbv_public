...
Route::get('/get-list-congkhai-days', 'PatientController@getListCongkhaiDays')->name('get-list-congkhai-days');
...
//    });
    ...
    */
    ...
    Route::get('index/category-service-req-type', 'Category\CategoryHISController@listServiceReqType')
    ->name('category-his.fetch-service-req-type');
	...
	*/
    ...
    Route::group(['prefix' => 'insurance/'], function () { 	
        ...
        // Ket qua da luu gan nhat - chi doc CSDL, khong cham cong nen tra ve tuc thi.
        Route::get('mcct/gan-nhat', 'Insurance\Manager\McctController@ganNhat')->name('insurance.mcct.gan-nhat');
    ...
    */
    ...
    Route::group(['prefix' => 'bhxh/', 'middleware' => ['checkrole:bhxh']], function () {
        ...
        Route::get('index/service-cdha-list', 'BhxhController@serviceCdhaList')
