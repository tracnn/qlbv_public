...
class Tt12Importer
{
     ...
     *
     * Dung truy van con thay vi nap danh sach id vao mang PHP: mot tep vai chuc nghin dong
     * se lam mang do phinh, ma may chu dat PHP 128 MB.
     */
    private function doSach($hoSo)
    {
        ...
        DB::transaction(function () use ($hoSo) {
            Tt12DongThuocPx::whereIn(
                'dong_id',
                Tt12Dong::where('ho_so_id', $hoSo->id)->select('id')
            )->delete();
